    ...
    public class SwiftBlade
    {
        ...
        public static void BuildAndRegister()
        {
            ...
            var upgrade = new CardUpgradeDataBuilder
            {
                ...
                UpgradeDescription = "增加单位 +5[attack] 和 -5[health] 并附加1层[quick]和1层[multistrike]", // 升级描述
                ...
                StatusEffectUpgrades = 
                {
                    ...
                    new StatusEffectStackData {statusId = VanillaStatusEffectIDs.Multistrike, count = 1}, // 添加1层多重攻击效果
                },
            ...
            new EnhancerDataBuilder
            {
                EnhancerID = ID,
                Name = "疾风之刃", // 强化器名称
                Description = "增加单位 +5[attack] 和 -5[health] 增加[quick]1和[multistrike]1", // 强化器描述
                EnhancerPoolIDs = { 
